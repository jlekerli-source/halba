...
| Field | Value or source | Status |
| --- | --- | --- |
| Project name | `Halba` | Ready |
| Tagline | `The evidence control plane that checks whether an AI agent's “done” can pass human review.` | Ready; under Devpost's 140-character limit |
| Gallery thumbnail | [`../artifacts/demo/devpost-thumbnail.png`](../artifacts/demo/devpost-thumbnail.png) | Ready; 1200 × 800 PNG, 3:2 |
| Project story | [`devpost.md`](devpost.md) | Ready in Devpost's standard story headings |
...
| Inspiration disclosure | [`attribution.md`](attribution.md) | Ready; independent work and non-affiliation stated |
