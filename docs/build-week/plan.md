...
| 10. Submission package | Public surfaces complete; current visual release pending deployment; Devpost blocked externally | Public screenshots, Devpost copy, 90-second live script, reproducible 58-second captioned film, architecture, disclosure, attribution, deployment guide, and evidence index are present. The redesigned app and film require a fresh release/deploy proof. Devpost last showed “Submissions open soon,” and its rules page said the official rules were not yet available. |
